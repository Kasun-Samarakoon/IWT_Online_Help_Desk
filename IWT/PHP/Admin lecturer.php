...
<center><h2>Registered Lecturers Details</h2></center>
...
$records = mysqli_query($db,"select * from lecturer"); 
...
?>
  <tr>
    ...
    <td><?php echo $data['l_stream']; ?></td>   
    <td><a href="Admin lecturer delete.php?id=<?php echo $data['id']; ?>"><input type="button" onclick="but()" value="Delete"></a></td>
  </tr>	
<?php
}
?>
